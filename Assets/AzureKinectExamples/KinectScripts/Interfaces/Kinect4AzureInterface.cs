        ...
        private void ProcessCameraFrames(KinectInterop.SensorData sensorData, Capture capture)
        {
            ...
            try
            {
                ...
                if (!isSyncBodyAndDepth || btCapture != null /**&& (btQueueCount == 0 && sensorData.lastBodyFrameTime == rawDepthTimestamp)*/)  // currentBodyTimestamp
                {
                    ...
                    // depth frame
                    if (capture.Depth != null && rawDepthImage != null && (getAllSensorFrames || rawDepthTimestamp == sensorData.lastDepthFrameTime))
                    {
                        //if (kinectPlayback != null)
                    ...
                    // color frame
                    if (capture.Color != null && rawColorImage != null && (getAllSensorFrames || rawColorTimestamp == sensorData.lastColorFrameTime))
                    {
                        //if (kinectPlayback != null)
                    ...
                    // infrared frame
                    if (capture.IR != null && rawInfraredImage != null && (getAllSensorFrames || rawInfraredTimestamp == sensorData.lastInfraredFrameTime))
                    {
                        //if (kinectPlayback != null)
